...
class SecretUtilsTest(unittest.TestCase):
    ...
    def test_missing_explicit_file_fails_without_leaking_value(self):
        with patch.dict(os.environ, {"TEST_MISSING_FILE": "missing-file"}, clear=False):
            with self.assertRaisesRegex(RuntimeError, "Unable to read secret file for TEST_MISSING"):
                read_secret("TEST_MISSING")
