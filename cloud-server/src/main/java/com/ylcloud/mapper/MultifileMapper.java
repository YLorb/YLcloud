...
public interface MultifileMapper {
    ...
    @Select("select id, upload_id as uploadId, file_key as fileKey, user_id as userId, parent_id as parentId, " +
            ...
            "status, file_uuid as fileUuid, last_activity_time as lastActivityTime, merge_started_time as mergeStartedTime, createtime, updatetime " +
            "from upload_task " +
    ...
    @Select("select id, upload_id as uploadId, file_key as fileKey, user_id as userId, parent_id as parentId, " +
            ...
            "file_uuid as fileUuid, last_activity_time as lastActivityTime, merge_started_time as mergeStartedTime, createtime, updatetime " +
