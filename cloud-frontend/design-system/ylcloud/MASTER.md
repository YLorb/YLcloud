...
**Project:** YLCloud
**Generated:** 2026-07-16 13:39:51
**Category:** Knowledge Asset Productivity SaaS
...
| Accent/Success/Confirm | `#047857` | `--color-success` |
| Warning | `#B45309` | `--color-warning` |
| Background | `#F7F8FC` | `--color-background` |
| Foreground | `#172033` | `--color-foreground` |
| Muted | `#EEF1F7` | `--color-muted` |
| Border | `#DDE3EE` | `--color-border` |
| Destructive/System Error | `#B91C1C` | `--color-destructive` |
| Ring | `#4F46E5` | `--color-ring` |

**Color Notes:** Indigo identifies navigation and selection. Green is reserved for successful outcomes and affirmative confirmation. Red is reserved for destructive actions, failed operations, and system errors. Every status also includes text and/or an icon; color is never the only signal. Page override files may change layout and density, but must not replace these global semantic roles.
